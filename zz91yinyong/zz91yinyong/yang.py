...
execfile(nowpath+"/func/yuanliao_function.py")
execfile(nowpath+"/func/taozaisheng_fun.py")
dbc=companydb()
dbtao=taozaishengdb()
zzyang=yang()
zzyuanliao=yuanliao()
zztzs=funtaozaisheng()
...
def yangad(request):
    ...
    adlistall=zzyuanliao.yuanliaoprolist(limit=int(l),keywords=keywords,adposition=adposition)
    ...
    return render_to_response('yang/yuanliao_js.html',locals())
...
def yangad_long(request):
    ...
    adlistall=zzyuanliao.yuanliaoprolist(limit=int(num),keywords=keywords,adposition=adposition,imgsize="100x100")
...
def tzsad_long(request):
    ...
    adlistall=zztzs.taoprolist(limit=int(num),keywords=keywords,adposition=adposition,imgsize="100x100")
    listall=adlistall["listall"]
    
    adcount=adlistall['listcount']
    
    lastpage=1
    return render_to_response('yang/tzsad_long.html',locals())
