...
class zz91page:
    ...
    def page_listcount(self):
        self._page_listcount = int(ceil(self._listcount / self._limitNum))
        return int(ceil(self._listcount / self._limitNum))
    ...
    def lastpage(self):
        if (self._page_listcount > 1 and self._nowpage < self._page_listcount):
            self._lastpage = self._page_listcount
            return self._page_listcount
        else:
            self._lastpage = None
            return None
