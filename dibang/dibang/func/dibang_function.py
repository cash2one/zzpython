...
class zzdibang:
    ...
    def company_list(self,frompageCount,limitNum,name=''):
        ...
        sqlc='select count(0) as count from company as a where a.id>0 '+sqls+''
    ...
    def supplier_save(self,request):
        ...
        if id:
            ...
            sql='insert into suppliers(selfid,iccode,ctype,group_id,company_id,name,htype,contact,mobile,pwd,address,bz,gmt_created) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
            result=self.dbd.updatetodb(sql,[selfid,iccode,ctype,group_id,company_id,name,htype,contact,mobile,pwd,address,bz,gmt_created])
