...
def trade_supply_list(request):
    ...
    userallr=zzs.gettradesupplylist(frompageCount=frompageCount,limitNum=limitNum)
    ...
    return render_to_response('trade/trade_supply_list.html',locals())
