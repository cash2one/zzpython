...
execfile(nowpath+"/func/comp_news_function.py")
execfile(nowpath+"/func/crmtools.py")
zzs=zznews()

def comp_news_list(request):
    ...
    userallr=zzs.getcompnews(frompageCount=frompageCount,limitNum=limitNum)
    ...
    return render_to_response('comp/comp_news_list.html',locals())
