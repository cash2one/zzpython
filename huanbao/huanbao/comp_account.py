...
execfile(nowpath+"/func/comp_account_function.py")
execfile(nowpath+"/func/crmtools.py")
zzs=zzaccount()

def comp_account_list(request):
    ...
    userallr=zzs.getcompaccountlist(frompageCount=frompageCount,limitNum=limitNum)
    ...
    return render_to_response('comp/comp_account_list.html',locals())
