...
execfile(nowpath+"/func/caigou_function.py")
execfile(nowpath+"/func/crmtools.py")
zzs=zzcaigou()

def caigoulist(request):
    ...
    userallr=zzs.getcaigoulist(frompageCount=frompageCount,limitNum=limitNum)
    ...
    return render_to_response('caigou/caigou_list.html',locals())
