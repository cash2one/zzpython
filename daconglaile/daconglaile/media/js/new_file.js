/*! TenVideoPlayer_V2 - v2.0.0 - 2016-12-06 19:31:45
 * Copyright (c) 2016
...
! function(a) {
	...
	if("undefined" == typeof a && (window.Zepto = b), function(a) {
		...
		}(b), tvp = {}, tvp.lastModify = "2016-12-06 19:31:45", tvp.ts = tvp.lastModify.replace(/\D/g, ""), tvp.ver = "$V2.0Build9133$", tvp.dataset = {
			openLazy: !0
	...
	var d = !1;
	"undefined" != typeof b && b._tvp ? (tvp.$ = b, d = !0) : (tvp.$ = {}, d = !1),
		function() {
			...
			a.app = {
				...
				buildResult: function(c, d, e) {
					...
					var i = a.app.getOpenUrl(d),
						j = this;
					if(h && !d.openUrl && (1 == g && (i += "&callback=weixin%3A%2F%2F&sender=%e5%be%ae%e4%bf%a1"), 2 == g && (i += "&callback=mqqapi%3A%2F%2F&sender=%E6%89%8B%E6%9C%BAQQ"), 3 == g && (i += "&callback=mqqbrowser%3A%2F%2F&sender=QQ%E6%B5%8F%E8%A7%88%E5%99%A8")), f = 1 == c ? i : b.os.iphone && parseInt(d.pay) && d.cid ? a.app.getPayUrl(d.cid) : j.getDownloadUrl(d.downloadUrl, d.appName), b.browser.WeChat && i && -1 === i.indexOf("wxplugopenid")) {
		...
		function(a) {
			...
			rcmdTextReport: function(a, b, c, d) {
				...
				var k = tvp.common.getCompleteUrlByProtocol("//btrace.video.qq.com/kvcollect?BossId=2745&Pwd=0&_dc=") + Math.random();
			...
			user_action_report: function(a) {
				var b = {
					...
					c = tvp.common.getCompleteUrlByProtocol("//btrace.video.qq.com/kvcollect?BossId=2797&Pwd=219856622&_dc=") + Math.random();
			...
			apprecommend_report: function(a) {
				...
				var f = {
					...
					g = tvp.common.getCompleteUrlByProtocol("//btrace.video.qq.com/kvcollect?BossId=2745&Pwd=0&_dc=") + Math.random();
						...
						C = function() {
							...
							r._rnd = c, x = u + b.param(r), f && "object" === b.type(f) && (x += "&" + b.param(f)), x = j(x, c), b.ajax({
								...
								if(!e.noAuth && c && 0 != c.em && "o" != c.s) {
									...
									if(83 === c.em && r.eduext);
									else if(!(b.inArray(c.em, [100]) > -1)) return e.noAuth = !0, e.defer = q, void a.h5Helper.loadVideoUrlByVid(e)
								}
								A(c)
							}).fail(function() {
								if(s.reportErr(), y({
			...
			if(!window.txvLogin) {
				...
				a.prototype = {
					...
					tvSwitchLogin: function(a, b) {
						b = b || function() {}, f.isipad ? b(new Error("iPad not support SwitchLogin")) : this.tenvideoJSReady(function() {
				...
				e.fn = e.prototype = new a.BaseHtml5, b.extend(e.prototype, {
					...
					play: function(c, d, e) {
						function g(e) {
							...
							var j, k = e ? i.curVideo.getHLS : i.curVideo.getMP4Url,
								l = i.curVideo.getVid();
					...
					onError: function(d, e) {
						...
						b.each(a.html5LiveFrontShow.plugins, function(a, b) {
							if("liveDownloader" == b.name) {
								var c;
								j && (c = j.getChannelId()), new b.key(g, {
									code: k,
									msg: d.errinfo,
									lid: c
								})
				...
				k || (k = a.$.newGuid(), b.setData(j, k)), g.fn = g.prototype = new a.BaseHtml5, b.extend(g.fn, {
					...
					play: function(c, f) {
						...
						var o, p = b.Deferred(),
							q = b.Deferred();
						if(m) {
							if(!/.*\.?qq\.com$/.test(n.host) && !/.*\.?qq\.com$/.test(m)) throw e(10, {
								config: j.config
					...
					report_h5_live: function(c) {
						...
						var u = {
							...
							v = new Image,
							w = "http://btrace.video.qq.com/kvcollect?BossId=2727&Pwd=1424084450&_dc=" + Math.random();
						w += "&" + b.param(u), v.src = w
					},
					isPlayingLoadingAd: function() {
						var a = 1 == this.$video.attr("data-playing-loadingad") || 1 == this.$video.attr("data-playing-adonend");
		...
		function(a, b) {
			...
			a.html5LiveFrontShow.plugins.push({
				...
				onDownloaderStatusChange: function() {
					function a(a) {
						var c = "";
						"downloading" === a ? c = "\u6b63\u5728\u4e0b\u8f7d\u817e\u8baf\u89c6\u9891" : "pause" === a ? c = "\u5df2\u6682\u505c\uff0c\u70b9\u51fb\u6062\u590d\u4e0b\u8f7d" : "complete" === a ? (c = "\u4e0b\u8f7d\u5df2\u5b8c\u6210\uff0c\u70b9\u51fb\u5b89\u88c5", a = "install") : "afterInstall" === a ? c = "\u5df2\u6682\u505c\uff0c\u70b9\u51fb\u6062\u590d\u4e0b\u8f7d" : "hasapp" === a && (c = b.renderData.btnText),
							c || (c = b.renderData.btnText), b.$btn.html(c), b.$btn.attr("data-status", a)
					}
					var b = this;
			...
			function d(d, e) {
				...
				this.getStepName = function(a) {
					...
					if(c) {
						...
						try {
							i.vt = e.curVideo.data.vl.vi[0].ul.ui[0].vt, i.tpay = e.curVideo.tpay
						} catch(m) {
							i.vt = 0
						}
						i.vurl = e.curVideo.url, i.bt = parseInt(e.getDuration(), 10), b.extend(k, i), k.step = c, k.ctime = b.getISOTimeFormat(), k.val = d, e && e.config && e.config.isShortVideo ? k.isshortvd = 1 : k.isshortvd = 0, k.opensource = {
							...
							"ugch5.m.v.qq.com": 2,
							"buluo.qq.com": 3
						}[a.$.getUrlParam("openS") || e.config.openS], k.opensource || (k.opensource = 0), e.config.openS && /^\d+$/.test(e.config.openS + "") && (k.opensource = e.config.openS), e.curVideo && e.curVideo.getGuid && (k.cmid = e.curVideo.getGuid()), k.ua = navigator.userAgent;
						for(var n in k) {
							var o = k[n];
		...
		function(a, b) {
			b.extend(a.Html5Tiny.fn, {
				buildmonitor: function() {
					...
					this.$video.on("playing", function() {
						setTimeout(function() {
							c.isPlayingLoadingAd() && (c.hasAds = !0, d && d.reportStep(7, {
								val1: 1
							}))
						}, 90)
						...
						d && (d.report(3, 1), d.reportStep(f ? 1009 : 1011, {
							val1: 1,
							val2: 0
						}))
			...
			a.Html5Bullet = function(a, b, c) {
				...
				init: function() {
					var a = this.player.config.html5LiveUIFeature,
						...
						d = this; - 1 !== a.indexOf("bullet") && c && this.player.config.isHtml5UseUI && (b(this.get_html()).appendTo(this.$videomod), this.setDomRole(), this.bulletId = this.player.curVideo.getH5BulletId(), this.bulletId && (this.check_bullet_db_switch().done(function() {
						d.init_events(), d.init_style(), d.set_top_values(), d.init_switch_status()
					}).fail(function() {}), this.player.sendMyBullet || (this.player.sendMyBullet = function(a) {
					...
					var y = function() {
						...
						z = function() {
							...
							if(d.trigger("tvp:player:videoreplay"), c.config.isHtml5ShowLoadingAdOnStart && c.config.isHtml5ShowLoadingAdOnReplay) {
								...
								else if(c.curVideo.getRequestAd() === !0) return
							}
		...
		function(a, b) {
			...
			b.extend(a.Html5Player || {}, {
				...
				buildfullscreen: function(d, e, f, g) {
					...
					a.Html5Player && a.Html5Player.fn && b.extend(a.Html5Player.fn, i), a.Html5Live && a.Html5Live.fn && b.extend(a.Html5Live.fn, i)
				},
				...
				enterFullScreen: function() {
					this.player.videoTag && 0 == this.player.videoTag.currentTime && b.os.ipad || (top === window || top.location.href || b.os.ios) && (this.player.config.isHtml5UseFakeFullScreen ? this.allEnterFullScreen() : this.enterRealFullScreen(), this.player.isFullScreen = !0, this.player.callCBEvent("onfullscreen", !0), a.bossReport.user_action_report({
						actions: "fullscreen",
				...
				cancelRealFullScreen: function() {
					var a = this,
						b = a.$video,
						c = b[0];
					this.fixClassName(0), document.webkitExitFullscreen && c.webkitExitFullscreen()
				},
				allCancelFullScreen: function() {
					...
					if(a && c) try {
						frameElement && (frameElement.style.cssText = e), this.cancelFakeFullScreen()
					} catch(d) {
				...
				allEnterFullScreen: function() {
					var a = this.player.config.isHtml5UseFakeFullScreen,
						...
						d = top.innerWidth;
					if(a && c) try {
						frameElement && (e = frameElement.style.cssText, b(frameElement).css({
				...
				enterFakeFullScreen: function() {
					if(!this.checkIsFullScreen()) {
						...
						f = this.player.$videomod[0].style.cssText, this.player.$videomod.find("video").off("ended.recommendshow").on("ended.recommendshow", function() {
						...
						c.removeClass("tvp_fullscreen"), c.addClass("tvp_unfullscreen"), this.$UILayer.addClass("tvp_fullscreen_mode")
					}
				},
				cancelFakeFullScreen: function() {
					this.fixClassName(0), this.$mod.trigger("tvp:bullet:cancelfullscreen");
					try {
						top.document.body.scrollTop = d
					} catch(a) {}
					f && (this.player.$videomod[0].style.cssText = f), c.removeClass("tvp_unfullscreen"), c.addClass("tvp_fullscreen"), this.$UILayer.removeClass("tvp_fullscreen_mode"), this.isRotate = !1, this.unbindOritationChange()
				},
					...
					var a = this.player,
						...
						e = function() {
							var e = top.innerWidth,
								f = top.innerHeight;
							g.s0 && g.s1 && (90 === Math.abs(top.orientation) ? (e = g.s1.width, f = g.s1.height) : (e = g.s0.width, f = g.s0.height)), window !== top && frameElement && b(frameElement).css({
								position: "fixed !important",
								...
								top: 0,
								left: 0
							}), c.isRotate = !1, top.document.body.scrollTop = d + 30, setTimeout(function() {
								top.document.body.scrollTop = d - 30
							}, 10), c.$mod && c.$mod.trigger && c.$mod.trigger("tvp:recommend:orientationchange"), c.$video && c.$video.trigger && setTimeout(function() {
				...
				androidScreenCalc: function(a) {
					var c = this;
					a = a || function() {}, g.times >= 2 || (g.times += 1, g.calcTimer = setInterval(function() {
						c.setCalcValue(), g.changeTimes >= 1 && (clearInterval(g.calcTimer), g.calcTimer = null, setTimeout(function() {
							c.setCalcValue(), a()
						}, 100))
					}, 50), b.os.iphone && setTimeout(function() {
						c.setCalcValue(), a()
					}, 100), setTimeout(function() {
						g.calcTimer && clearInterval(g.calcTimer), c.setCalcValue(), a()
					}, 2e3))
				},
				setCalcValue: function() {
					...
					90 === Math.abs(top.orientation) ? (g.s1 && g.s1.width !== a.width && g.changeTimes++, g.s1 = a) : (g.s0 && g.s0.width !== a.width && g.changeTimes++, g.s0 = a)
				},
		...
		function(a, b) {
			a.FlashLivePlayer = function(c, d) {
				...
				return b && b.id && a.Player && a.Player.instance ? (c = a.Player.instance[b.id] || {}, c.playerid ? (d = a.$("#" + c.playerid), d && d.length ? (e = d.parent()[0], b.enter ? (c._cache_flash_style = d[0].style.cssText, c._cache_flash_parent_style = d.parent()[0].style.cssText, d.css({
					...
					overflow: "hidden"
				}), c._cache_flash_isfullscreen = !0, "function" === a.$.type(c.onFlashFakeFullScreenChange) && c.onFlashFakeFullScreenChange.call(c, {
					isFull: 1,
					flash: d
				}), !0) : (d[0].style.cssText = c._cache_flash_style, d.parent()[0].style.cssText = c._cache_flash_parent_style, $j("html,body").css({
					overflow: "auto"
				}), c._cache_flash_isfullscreen = !1, "function" === a.$.type(c.onFlashFakeFullScreenChange) && c.onFlashFakeFullScreenChange.call(c, {
					isFull: 0,
					flash: d
				}), !0)) : !1) : !1) : !1
			}, window.toggleFakeFullScreen = function(b) {
	...
	! function(a, b) {
		...
		a.FlashPlayer = function(c, d) {
			...
			var d, e;
			if(c && c.id && a.Player && a.Player.instance) d = a.Player.instance[c.id] || {};
	...
	function(a, b) {
		...
		function(a, b) {
			...
			b.extend(c.prototype, {
				...
				fixStyle: function() {
					(b.os.android && window.screen.width > 480 || b.os.iphone && window.screen.width <= 320) && this.$box.addClass("tvp_fixRight"), this.op.appName && this.op.logoClass && this.$box.addClass(this.op.logoClass), 0 === this.$text1.length && this.$mod.width() === window.innerWidth && this.$mod.css({
				...
				bindTap: function() {
					...
					}), 1 != d.info.hasApp && (a.app.bindTryOpenAppBanner && a.app.bindTryOpenAppBanner(d), b.os.android && !e.downloadUrl && (e.downloadUrl = a.app.getDownloadUrl(!1, e.appName)), b.os.android && !e.downloadPage && a.app.getAppMd5(e.promotionId, e.appName).done(function(a) {
