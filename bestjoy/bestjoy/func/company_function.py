...
class customer:
    ...
    def getsalesman_bycompid(self,company_id):
        sql='select u.realname as salesman,k.gmt_created,k.emphases from user as u left join kh_assign as k on k.user_id=u.id where k.company_id=%s'
        result=db.fetchonedb(sql,[company_id])
        return result
