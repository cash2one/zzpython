...
CACHE_BACKEND = 'memcached://7002.zz91server.com:11211/?max_entries=2048&timeout=5&cull_percentage=10'
...
ROOT_URLCONF = 'bestjoy.urls'
SESSION_FILE_PATH = '/tmp/'
TEMPLATE_DIRS = (
	os.path.join(os.path.dirname(__file__), 'templates/'),
)
WSGI_APPLICATION = 'bestjoy.wsgi.application'
INSTALLED_APPS = (
    'django.contrib.auth',
