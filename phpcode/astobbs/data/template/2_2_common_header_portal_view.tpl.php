...
0
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_common.htm', 1488361009, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/xinrui_iuni', 'common/header_portal_view')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_qmenu.htm', 1488361009, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/xinrui_iuni', 'common/header_portal_view')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/xinrui_iuni/common/pubsearchform.htm', 1488361009, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/xinrui_iuni', 'common/header_portal_view')
;?>
