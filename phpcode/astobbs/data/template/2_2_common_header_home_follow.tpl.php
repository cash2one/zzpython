...
0
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_common.htm', 1487560768, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/xinrui_iuni', 'common/header_home_follow')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_qmenu.htm', 1487560768, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/xinrui_iuni', 'common/header_home_follow')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/xinrui_iuni/common/pubsearchform.htm', 1487560768, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/xinrui_iuni', 'common/header_home_follow')
;?>
