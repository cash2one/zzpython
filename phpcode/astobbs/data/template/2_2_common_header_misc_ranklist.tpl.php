...
0
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_common.htm', 1487561314, '2', './data/template/2_2_common_header_misc_ranklist.tpl.php', './template/xinrui_iuni', 'common/header_misc_ranklist')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_qmenu.htm', 1487561314, '2', './data/template/2_2_common_header_misc_ranklist.tpl.php', './template/xinrui_iuni', 'common/header_misc_ranklist')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/xinrui_iuni/common/pubsearchform.htm', 1487561314, '2', './data/template/2_2_common_header_misc_ranklist.tpl.php', './template/xinrui_iuni', 'common/header_misc_ranklist')
;?>
...
<?php } ?>
<link type="text/css" rel="stylesheet" href="template/xinrui_iuni/common/extend_common.css">
</head>
