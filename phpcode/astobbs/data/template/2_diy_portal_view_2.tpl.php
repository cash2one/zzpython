...
0
|| checktplrefresh('data/diy/./template/xinrui_iuni//portal/view_2.htm', './template/default/portal/portal_comment.htm', 1488361009, 'diy', './data/template/2_diy_portal_view_2.tpl.php', 'data/diy/./template/xinrui_iuni/', 'portal/view_2')
|| checktplrefresh('data/diy/./template/xinrui_iuni//portal/view_2.htm', './template/default/common/seccheck.htm', 1488361009, 'diy', './data/template/2_diy_portal_view_2.tpl.php', 'data/diy/./template/xinrui_iuni/', 'portal/view_2')
