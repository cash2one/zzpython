...
0
|| checktplrefresh('./template/xinrui_iuni/forum/viewthread.htm', './template/xinrui_iuni/forum/viewthread_node.htm', 1487561265, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_iuni', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_iuni/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1487561265, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_iuni', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_iuni/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1487561265, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_iuni', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_iuni/forum/viewthread.htm', './template/default/common/seditor.htm', 1487561265, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_iuni', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_iuni/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1487561265, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_iuni', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_iuni/forum/viewthread.htm', './template/default/common/upload.htm', 1487561265, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_iuni', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_iuni/forum/viewthread.htm', './template/default/common/seccheck.htm', 1487561265, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_iuni', 'forum/viewthread')
...
<div class="y">
<div class="pgt y"><?php echo $multipage;?></div>
<span class="z" <?php if($_G['setting']['visitedforums']) { ?> id="visitedforums" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'34'})"<?php } ?>><a href="<?php echo $upnavlink;?>">返回列表</a></span>
</div>
</div>
