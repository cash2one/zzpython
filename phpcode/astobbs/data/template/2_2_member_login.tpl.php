...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1487649388, '2', './data/template/2_2_member_login.tpl.php', './template/xinrui_iuni', 'member/login')
